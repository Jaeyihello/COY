...
const names = ["배구부 선배", "도서부 선배", "반장", "미술부장", "절친", "연습생"];
    ...
    return(
        <div>
            ...
            <select onChange={onSelectName}>
                <option value="0">배구부 선배</option>
                <option value="1">도서부 선배</option>
                <option value="2">반장</option>
                <option value="3">미술부장</option>
                <option value="4">절친</option>
