...
const lovers = [ //캐릭터별 장소, 이유, lover인지 아닌지, fakelover인지 아닌지, 대화를 해봤는지 아닌지
    {name:"짝꿍", place:null, reason:null, lover:false, fake_lover:false, isMet:false},
    {name:"반장", place:null, reason:null, lover:false, fake_lover:false, isMet:false},
    {name:"소꿉친구", place:null, reason:null, lover:false, fake_lover:false, isMet:false},
    {name:"배구부", place:null, reason:null, lover:false, fake_lover:false, isMet:false},
    {name:"미술부", place:null, reason:null, lover:false, fake_lover:false, isMet:false},
